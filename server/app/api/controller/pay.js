...
module.exports = class extends Base {
  ...
  preWeixinPayAction() {
    ...
    return _asyncToGenerator(function*() {
      ...
      try {
        ...
        return _this2.fail(400, "微信支付失败?" + err);
      }
    })();
  }
  notifyAction() {
  ...
  afterPay(orderInfo) {
    ...
    return _asyncToGenerator(function*() {
      if (orderInfo.order_type == 0) {
        let orderGoodsList = yield _this4
          .model("order_goods")
          .where({
