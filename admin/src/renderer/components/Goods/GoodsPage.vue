          ...
          <el-table-column type="expand">
            <template slot-scope="props">
              <el-table :data="props.row.product" style="width: 100%" stripe>
                ...
                <el-table-column prop="goods_aka" label="快递单上的简称" width="100">
                  <template scope="scope">
                    <el-input size="mini" v-model="scope.row.goods_name" placeholder="简称"></el-input>
                  </template>
                </el-table-column>
                <el-table-column prop="goods_origin" label="产地" width="80">
                  <template scope="scope">
                    <el-input size="mini" v-model="scope.row.goods_origin" placeholder="如：沈阳"></el-input>
                  </template>
                </el-table-column>
                <el-table-column prop="goods_expiration" label="保质期" width="80">
                  <template scope="scope">
